...
$U_{senfer}=\frac{n * L/R}{RTT + l/R}$ n为流水线深度
...
$EstimatedRTT = (1- \alpha )*EstimatedRTT + \alpha *SampleRTT$ alpha经常取0.125

因为RTT有变化，所以还需要加上一些允许的延迟4*DevRTT：
$TimeoutInterval = EstimatedRTT + 4*DevRTT$
其中DevRTT是SampleRTT和EstimatedRTT的偏差
$DevRTT = (1-\beta)*DevRTT + \beta*|SampleRTT-EstimatedRTT|$ beta常取0.25
